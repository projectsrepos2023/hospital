        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-7 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item active">Register surgical</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card patients-list">
                    ...
                    <div class="body">
                    <button type="button" class="btn btn-primary btn-round btn-success waves-effect" data-toggle="modal" data-target="#addevent"">Register surgical</button>
                ...
                <div class="header">
                        <h2><strong>surgical</strong> List</h2>
